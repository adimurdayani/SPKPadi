					...
					<tr>
						...
						<td align="right">
							...
							<button type="button" class="btn btn-primary btn-sm"
								onclick="edit('{{ route('penyakit.edit', $penyakit->id) }}')" data-toggle="modal"
								data-target="#edit"><i class="fa fa-edit"></i></button>
							<button type="button" class="btn btn-danger btn-sm"
								onclick="$('form[name={{ $penyakit->id }}]').submit();"><i
									class="fa fa-trash"></i></button>
							<form name="{{ $penyakit->id }}" method="post"
							...
							@else
							<button type="button" class="btn btn-primary btn-sm"
								onclick="show('{{ route('detail', $penyakit->id) }}')" data-toggle="modal"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<div class="checkbox">
											<label><input type="checkbox" name="gejala[]" value="{{ $gejala->id }}">{{
												$gejala->name }}</label>
										</div>
										@endforeach
									</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" onclick="$('#add form').submit();">Tambahkan <i
...
<div id="edit" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" onclick="$('#edit form').submit();">Simpan Perubahan <i
						class="fa fa-pencil fa-fw"></i></button>
			</div>
		</div>
	</div>
</div>
